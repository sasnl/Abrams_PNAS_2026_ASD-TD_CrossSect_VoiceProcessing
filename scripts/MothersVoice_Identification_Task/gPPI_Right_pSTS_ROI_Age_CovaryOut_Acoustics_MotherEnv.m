...
td_roi_sig_fname  = fullfile(roi_dir, 'TDonly_n40_gPPI_SigLev_MothEnv_NEG_R_pSTS_Age_Int.mat');
asd_roi_sig_fname = fullfile(roi_dir, 'ASDonly_n39_gPPI_SigLev_MothEnv_NEG_R_pSTS_Age_Int.mat');
...
out_csv      = fullfile(out_dir, 'gPPI_R_MotherEnv_AgeXGroup_AcousticsControl_ROI_LEAN.csv');      % formatted (SI-ready)
out_csv_raw  = fullfile(out_dir, 'gPPI_R_MotherEnv_AgeXGroup_AcousticsControl_ROI_LEAN_raw.csv');  % numeric
