...
paralist.subjectlist = '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/scripts/groupmatch/female_subjectslist_SL.csv';

% Please specify the path for the output comma separated subject list file.
% The output subjects will be saveed in this file.
paralist.selectedsubjectlist = '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/scripts/groupmatch/sel_fem_subjectslist_SL.csv';

% Please specify the desired number of subjects that are to be selected
paralist.numberofselectedsubjects = 11;
...
paralist.var_type = [1 1 1 1 1 1 1];
...
paralist.var_mean = [0 0 0 111.85 0 0 2.05];
...
paralist.var_priority = [0 0 0 2 0 0 1];
