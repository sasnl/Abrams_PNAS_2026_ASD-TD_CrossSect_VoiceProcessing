...
td_roi_sig_fname  = fullfile(roi_dir, 'TDonly_n40_gPPI_SigLev_MothOth_NEG_L_pSTS_Age_Int');
asd_roi_sig_fname = fullfile(roi_dir, 'ASDonly_n39_gPPI_SigLev_MothOth_NEG_L_pSTS_Age_Int.mat');
...
out_csv      = fullfile(out_dir, 'gPPI_L_MothOth_NEG_AgeXGroup_AcousticsControl_ROI_LEAN.csv');      % formatted (SI-ready)
out_csv_raw  = fullfile(out_dir, 'gPPI_L_MothOth_NEG_AgeXGroup_AcousticsControl_ROI_LEAN_raw.csv');  % numeric
