...
%single folder
paralist.stats_folder_path_list = 'glm_one_sample_covar_age_omnibus_ASD_TD_spm12';
...
paralist.contrast_folder_list = '011T_speech_min_environ';
...
paralist.currentdir =  '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/results/taskfmri/groupstats/glm';
...
% If no mask:
paralist.mask_file = '//oak/stanford/groups/menon/projects/daa/Abrams_Utils/HarvardOxford_ROIs/HO_Right_Superior_Parietal_Lobule.nii';
...
paralist.spatial_extent = 0;

% Please specify the group name for txt files
paralist.user_input = 'group_mask';
