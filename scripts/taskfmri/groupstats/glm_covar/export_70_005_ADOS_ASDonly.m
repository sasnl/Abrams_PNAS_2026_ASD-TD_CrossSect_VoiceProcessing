...
paralist.stats_folder_path_list = 'glm_one_sample_covar_ADOS_ASDonly_spm12';
...
paralist.contrast_folder_list = 'contrastlist.txt';
...
%paralist.mask_file = '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/imaging/roi/fsl41_greymatter_bin.nii';
% If no mask:
paralist.mask_file = '';
