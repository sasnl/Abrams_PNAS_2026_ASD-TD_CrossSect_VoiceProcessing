...
roidir="/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/imaging/roi/glm_clusters"
outdir="/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/results/taskfmri/groupstats/glm_signals_betas/"
## declare an array variable
roilist=(Age_TD_ASD_001Mother_Environ/c1_angular_left
Age_TD_ASD_001Mother_Environ/c2_insula_left
Age_TD_ASD_001Mother_Environ/c3_mfg_left
Age_TD_ASD_001Mother_Environ/c4_precuneus
Age_TD_ASD_001Mother_Environ/c5_sfg
Age_TD_ASD_001Mother_Environ/c6_angular_right
Age_TD_ASD_003Other_Environ/c1_insula_left
Age_TD_ASD_003Other_Environ/c2_angular_right
Age_TD_ASD_003Other_Environ/c3_mfg_left
Age_TD_ASD_009Mother_Other/c1_mfg_left
Age_TD_ASD_009Other_Mother/c1_sfg_left)
...
do
  ...
  do
    ...
    fslstats $indir/$i/$modality/con_0001_noNan.nii -k $roidir/$roi -M >> $outdir/$roi/mother_min_environ.txt
    fslstats $indir/$i/$modality/con_0003_noNan.nii -k $roidir/$roi -M >> $outdir/$roi/other_min_environ.txt
    fslstats $indir/$i/$modality/con_0009_noNan.nii -k $roidir/$roi -M >> $outdir/$roi/mother_min_other.txt
