...
paralist.output_folder = 'glm_one_sample_covar_ADOS_ASDonly';
...
paralist.reg_file = {'/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/behavior/ASD_selected_n39_ADOS_SocAffect.txt'};
