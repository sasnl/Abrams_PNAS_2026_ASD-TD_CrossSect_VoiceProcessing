...
paralist.subjlist_file = {'/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/subjectlist/TD_selected_PID_List.csv'};  
%---- csv file example ----
%- PID, visit, session
%- 7014, 1 ,1
...
paralist.output_folder = 'glm_covar_age_TD_only';
...
paralist.reg_file = {'/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/behavior/TD_selected_age_scan.txt'};
