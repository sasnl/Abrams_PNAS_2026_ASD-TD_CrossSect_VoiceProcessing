...
% ======================================
% Config Files
save_dir = '/Users/daa/Documents/Scratch/TD_ASD_CrossSectional/Figure_Generation/Scatterplots/OtherEnv_Scatters';
ASD_save_fname = 'ASDonly_n39_SigLevels_Age_OtherEnv.mat';
TD_save_fname = 'TDonly_n40_SigLevels_Age_OtherEnv.mat';
...
color_plots(1,:) =  [255 0 0]; % This is red for AI 
color_plots(2,:) =  [153 0 0]; % This is maroon for OFC
color_plots(3,:) =  [128 0 128]; % This is purple for DLPFC
color_plots(4,:) =  [153 0 0]; % This is maroon for Putamen
color_plots(5,:) =  [56 171 17]; % This is green for Precun
color_plots(6,:) =  [56 171 17]; % This is green for AG
