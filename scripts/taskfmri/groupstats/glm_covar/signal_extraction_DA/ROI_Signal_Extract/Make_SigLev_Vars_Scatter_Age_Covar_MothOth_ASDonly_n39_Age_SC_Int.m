...
roi_fname{1} = 'roi_01_Left_OFC_4mm_-26_30_-12.nii';
roi_name{1} = 'Left_OFC';

roi_fname{2} = 'roi_02_Right_OFC_4mm_48_28_-4.nii';
roi_name{2} = 'Right_OFC';
...
save_fname = 'ASDonly_n39_GLM_SigLev_Age_SC_Int_MothOth.mat';
