...
sub_list = '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/subjectlist/ASD_selected_PID_List.csv';
roi_dir = '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/scripts/taskfmri/groupstats/glm_covar/signal_extraction_DA/ROI_Creation/OtherMother_ROIs';
...
con_fname = 'con_0010.nii';

roi_fname{1} = 'roi_01_Left_PreCentral.nii';
roi_name{1} = 'Left_PreCent';
...
save_fname = 'ASDonly_n40_SigLevels_Age_OtherMother.mat';
