...
% ------------------------------------------------------------------------------------------------
output_dir = ['/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/scripts/taskfmri/groupstats/glm_covar/signal_extraction_DA/ROI_Creation/MotherEnv_ROIs'];
% ------------------------------------------------------------------------------------------------
...
Add_On_Region_MNI_Coordinates{1} = [-30 18 -6];
...
Add_On_Region_Name{3} = 'Left_Precun';
Add_On_Region_MNI_Coordinates{3} = [0 -62 44];
Add_On_Region_Radius{3} = 4;

Add_On_Region_Name{4} = 'Right_AG';
Add_On_Region_MNI_Coordinates{4} = [56 -54 26];
Add_On_Region_Radius{4} = 4;

Add_On_Region_Name{5} = 'Left_DLPFC';
Add_On_Region_MNI_Coordinates{5} = [-42 12 34];
