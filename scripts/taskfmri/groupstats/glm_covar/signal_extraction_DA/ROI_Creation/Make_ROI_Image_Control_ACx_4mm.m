...
% ------------------------------------------------------------------------------------------------
output_dir = '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/scripts/taskfmri/groupstats/glm_covar/signal_extraction_DA/ROI_Creation/Control_ROIs_ACx';
% ------------------------------------------------------------------------------------------------
...
Add_On_Region_Name{1} = 'Left_HG';
Add_On_Region_MNI_Coordinates{1} = [-46 -21 6];
Add_On_Region_Radius{1} = 4;

Add_On_Region_Name{2} = 'Right_HG';
Add_On_Region_MNI_Coordinates{2} = [46 -21 6];
Add_On_Region_Radius{2} = 4;

Add_On_Region_Name{3} = 'Left_PT';
Add_On_Region_MNI_Coordinates{3} = [-55 -30 12];
Add_On_Region_Radius{3} = 4;

Add_On_Region_Name{4} = 'Right_PT';
Add_On_Region_MNI_Coordinates{4} = [55 -30 12];
Add_On_Region_Radius{4} = 4;

Add_On_Region_Name{5} = 'Left_PP';
Add_On_Region_MNI_Coordinates{5} = [-50 0 -1];
Add_On_Region_Radius{5} = 4;

Add_On_Region_Name{6} = 'Right_PP';
Add_On_Region_MNI_Coordinates{6} = [50 0 -1];
