...
% ------------------------------------------------------------------------------------------------
output_dir = ['/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/scripts/taskfmri/groupstats/glm_covar/signal_extraction_DA/ROI_Creation/OtherEnv_ROIs'];
% ------------------------------------------------------------------------------------------------
...
Add_On_Region_Name{1} = 'Left_AI';
Add_On_Region_MNI_Coordinates{1} = [-30 16 -12];
Add_On_Region_Radius{1} = 2;

Add_On_Region_Name{2} = 'Left_OFC';
Add_On_Region_MNI_Coordinates{2} = [-30 22 -10];
Add_On_Region_Radius{2} = 4;

Add_On_Region_Name{3} = 'Left_DLPFC';
Add_On_Region_MNI_Coordinates{3} = [-40 12 36];
Add_On_Region_Radius{3} = 4;

Add_On_Region_Name{4} = 'Left_Putamen';
Add_On_Region_MNI_Coordinates{4} = [-24 4 -10];
Add_On_Region_Radius{4} = 2;

Add_On_Region_Name{5} = 'Left_Precun';
Add_On_Region_MNI_Coordinates{5} = [0 -62 44];
Add_On_Region_Radius{5} = 4;

Add_On_Region_Name{6} = 'Right_AG';
Add_On_Region_MNI_Coordinates{6} = [64 -48 14];
Add_On_Region_Radius{6} = 4;
