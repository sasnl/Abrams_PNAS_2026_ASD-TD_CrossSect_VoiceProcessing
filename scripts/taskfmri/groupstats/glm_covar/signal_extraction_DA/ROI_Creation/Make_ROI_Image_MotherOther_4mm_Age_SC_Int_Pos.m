...
% These are for Mother min Other, Age X SC Interactions Positive, 
% GLM
Add_On_Region_Name{1} = 'Left_OFC_4mm_-26_30_-12';
Add_On_Region_MNI_Coordinates{1} = [-26 30 -12];
Add_On_Region_Radius{1} = 4;

Add_On_Region_Name{2} = 'Right_OFC_4mm_48_28_-4';
Add_On_Region_MNI_Coordinates{2} = [48 28 -4];
Add_On_Region_Radius{2} = 4;
