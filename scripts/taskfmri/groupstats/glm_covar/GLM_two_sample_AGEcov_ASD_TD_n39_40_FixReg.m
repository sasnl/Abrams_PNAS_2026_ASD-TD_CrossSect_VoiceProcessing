...
paralist.subjlist_file = {'/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/subjectlist/ASD_selected_PID_List_n39_ADOS.csv', '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/subjectlist/TD_selected_PID_List.csv'};  
%---- csv file example ----
%- PID, visit, session
%- 7014, 1 ,1
...
paralist.output_folder = 'glm_two_sample_covar_age_ASD_TD_n39_40_FixReg';
...
%THIS IS OLD REG CONFIG:  paralist.reg_file = {'/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/behavior/FullSample_selected_ASD_TD_age_scan_n39_40.txt'};
paralist.reg_file = {'/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/behavior/ASD_selected_age_scan_n39_ADOS_Zeros.txt',...
    '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/behavior/TD_selected_age_scan_Zeros.txt'};
