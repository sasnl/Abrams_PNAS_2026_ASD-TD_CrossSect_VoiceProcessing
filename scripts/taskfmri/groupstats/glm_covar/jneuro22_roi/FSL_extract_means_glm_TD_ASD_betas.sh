...
outdir="/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/results/taskfmri/groupstats/glm_jneuro22_betas/"
...
do
  ...
  do
    ...
    fslmaths $indir/$i/$modality/con_0001.nii -nan $indir/$i/$modality/con_0001_noNan.nii
    fslmaths $indir/$i/$modality/con_0003.nii -nan $indir/$i/$modality/con_0003_noNan.nii
    fslmaths $indir/$i/$modality/con_0009.nii -nan $indir/$i/$modality/con_0009_noNan.nii
    fslstats $indir/$i/$modality/con_0001_noNan -k $roidir/$roi -M >> $outdir/$roi/mother_min_environ.txt
    fslstats $indir/$i/$modality/con_0003_noNan -k $roidir/$roi -M >> $outdir/$roi/other_min_environ.txt
    fslstats $indir/$i/$modality/con_0009_noNan -k $roidir/$roi -M >> $outdir/$roi/mother_min_other.txt
