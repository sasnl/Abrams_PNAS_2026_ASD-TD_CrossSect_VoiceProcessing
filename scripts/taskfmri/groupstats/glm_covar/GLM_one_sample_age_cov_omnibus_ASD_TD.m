...
paralist.subjlist_file = {'/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/subjectlist/FullSample_selected_PID_List.csv'};  
%---- csv file example ----
%- PID, visit, session
%- 7014, 1 ,1
...
paralist.output_folder = 'glm_one_sample_covar_age_omnibus_ASD_TD';
