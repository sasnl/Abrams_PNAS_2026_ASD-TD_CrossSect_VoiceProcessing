...
paralist.subjlist_file = {'/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/subjectlist/ASD_selected_PID_List_n39_ADOS.csv'};  
%---- csv file example ----
%- PID, visit, session
%- 7014, 1 ,1
...
paralist.output_folder = 'glm_covar_Age_ADOS_Interaction_ASD_only';
...
paralist.reg_file = {'/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/behavior/Age_SC_Interaction_Centered/Age_centered.txt',...
    '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/behavior/Age_SC_Interaction_Centered/SC_centered.txt',...
    '/oak/stanford/groups/menon/projects/leipold/2022_ASD_CrossDevelop/data/behavior/Age_SC_Interaction_Centered/AgeXSC.txt'};
