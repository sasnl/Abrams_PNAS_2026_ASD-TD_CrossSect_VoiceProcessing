...
paralist.stats_folder  = 'stats_swgcar_gPPI_triplenet_betas/PPI_roi13_right_pSTS.nii';

% Plese specify the folder name to put the groupstats analysis results
paralist.output_folder = 'gPPI_two_sample_covar_age_ASD_TD/PPI_right_pSTS';
