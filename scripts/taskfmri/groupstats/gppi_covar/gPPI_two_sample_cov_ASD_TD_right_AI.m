...
paralist.stats_folder  = 'stats_swgcar_gPPI_triplenet_betas/PPI_roi10_right_ant_insula';

% Plese specify the folder name to put the groupstats analysis results
paralist.output_folder = 'gPPI_two_sample_covar_age_ASD_TD/PPI_right_AI';
